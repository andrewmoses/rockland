...
$(document).ready(function(){
	...
	$('nav.menu ul.main-menu>li>a').on('click', function(e){
		...
		{
			//commented the below code to abolish unwanted behaviours
			//e.preventDefault();
...
/*Have commented the below lines : they are the dataloaders, need to integrate them into angularjs code ****/
